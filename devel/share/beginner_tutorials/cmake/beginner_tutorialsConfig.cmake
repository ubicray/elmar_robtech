...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/tudeng/elmar_robtech/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/tudeng/elmar_robtech/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/tudeng/elmar_robtech/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Elmar <ubicray@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tudeng/elmar_robtech/src/beginner_tutorials/${idir}'.  Ask the maintainer 'Elmar <ubicray@gmail.com>' to fix it.")
    endif()
