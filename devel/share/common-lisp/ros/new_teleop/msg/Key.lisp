...
(cl:defmethod cl:initialize-instance :after ((m <Key>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Key)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name new_teleop-msg:<Key> is deprecated: use new_teleop-msg:Key instead.")))

(cl:ensure-generic-function 'key_code-val :lambda-list '(m))
(cl:defmethod key_code-val ((m <Key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_teleop-msg:key_code-val is deprecated.  Use new_teleop-msg:key_code instead.")
  (key_code m))

(cl:ensure-generic-function 'key_name-val :lambda-list '(m))
(cl:defmethod key_name-val ((m <Key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_teleop-msg:key_name-val is deprecated.  Use new_teleop-msg:key_name instead.")
  (key_name m))

(cl:ensure-generic-function 'key_pressed-val :lambda-list '(m))
(cl:defmethod key_pressed-val ((m <Key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader new_teleop-msg:key_pressed-val is deprecated.  Use new_teleop-msg:key_pressed instead.")
  (key_pressed m))
